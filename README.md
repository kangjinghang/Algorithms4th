...
>这个项目包含《算法（第4版）》书中的代码和本人对部分课后练习的解答。分享给大家来一起学习。部分答案参考自：[jimmysuncpt](https://github.com/jimmysuncpt/Algorithms)，非常感谢！
...
> [百度网盘：算法(第四版) 谢路云译 PDF ](https://pan.baidu.com/s/1n3wd5nWXhXKKLlo1HObjWA?pwd=5ik9) 提取码: 5ik9

目录
----

### 第1章 基础
&emsp;[1.1 基础编程模型](https://github.com/kangjinghang/Algorithms4th/tree/main/src/main/java/io/github/kangjinghang/chapter1_1)<br />
&emsp;[1.2 数据抽象](https://github.com/kangjinghang/Algorithms4th/tree/main/src/main/java/io/github/kangjinghang/chapter1_2)<br />
&emsp;[1.3 背包、队列和栈](https://github.com/kangjinghang/Algorithms4th/tree/main/src/main/java/io/github/kangjinghang/chapter1_3)<br />
